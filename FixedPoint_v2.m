...
while ~less_than_threshold(progress_Y, threshold) && n_iters < 10000
    for op=1 : n_ops
        Etmp = value(E{op});
        ...
        Constraints = [Constraints, addConstraints];
        addConstraints =  get_greaterzero_constraints(Du{op});
        Constraints = [Constraints, addConstraints];
...
plot_cells(progress_X, progress_Y, objs, 'v2');
